  ...
  return (
    <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
      ...
      >
        <button
          onClick={() => navigate("/")}
          aria-label="InterviewIQ.AI - Go to home page"
          className="flex items-center gap-3 rounded-xl p-1.5 hover:bg-gray-100 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 cursor-pointer"
        >
