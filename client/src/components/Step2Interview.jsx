        ...
        <div className="flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative">
          ...
          {!feedback ? (<div className="flex items-center gap-4 mt-6">
            ...
            <motion.button
              onClick={toggleMic}
              whileTap={{ scale: 0.9 }}
              aria-label={isMicOn ? (isListening ? "Microphone active - click to mute" : "Microphone on - click to mute") : "Microphone muted - click to unmute"}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-5 py-2 rounded-full bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700 transition disabled:bg-gray-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2"
            >
            ...
            {onFinish && (
              <motion.button
                ...
                whileTap={{scale: 0.95}}
                className="ml-auto px-5 py-2 rounded-full bg-gray-200 text-gray-700 text-sm font-medium hover:bg-gray-300 transition disabled:bg-gray-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2">
